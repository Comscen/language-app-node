...
module.exports = {
    firebase, checkIfWordExists, updateWordAmount, getWordAmount, getWordByText: getWordByTextReference, updateWord, saveWords,
    ...
    signUpWithEmailAndPassword, deleteSession, generateTestQuestions, admin
}